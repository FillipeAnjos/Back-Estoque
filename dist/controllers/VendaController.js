...
var _VendaService = require("../services/VendaService");
...
class VendaController {
  async salvarVenda(request, response) {
    ...
    const venda = vendaService.salvarVenda({
      id_user,
      itens,
      modalidade,
      valores,
  ...
  async listarVendasParam(request, response) {
    ...
    const vendaService = new _VendaService.VendaService();
    const vendas = vendaService.listarVendasParam({
      filtro,
      dados,
      acao
    });
  ...
  async relatorioVendas(request, response) {
    ...
    const vendaService = new _VendaService.VendaService();
    const vendas = vendaService.relatorioVendas({
      filtro,
      dados,
      dadosdataini,
      dadosdatafim,
  ...
  async relatorioFechamentos(request, response) {
    ...
    const vendaService = new _VendaService.VendaService();
    const vendas = vendaService.relatorioFechamentos({
      filtro,
      dados,
      dadosdataini,
      dadosdatafim,
