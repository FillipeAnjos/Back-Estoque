            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, clienteRepository.save(clienteCreate)];
                    case 1:
                        clienteSalvar = _a.sent();
                        if (!clienteSalvar) {
                            return [2 /*return*/, { error: true, msg: "Error ao tentar cadastrar o cliente." }];
                        }
                        return [4 /*yield*/, clienteRepository.query("select max(id) as id_cliente from clientes")];
                    case 2:
                        idInserido = _a.sent();
                        ...
                        if (!enderecoCadastrar) {
                            return [2 /*return*/, { error: true, msg: "Error ao tentar cadastrar o endereço do cliente." }];
                        }
                        ...
                        if (!telefoneCadastrar) {
                            return [2 /*return*/, { error: true, msg: "Error ao tentar cadastrar o telefone do cliente." }];
                        }
                        return [2 /*return*/, { error: false, msg: "Cliente cadastrado com sucesso." }];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, clienteRepository.query(dadosClientes)];
                    case 1:
                        filtrarClientes = _a.sent();
                        return [2 /*return*/, filtrarClientes];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, clienteRepository.query("delete from enderecos where id_cliente = ".concat(id))];
                    case 1:
                        endereco = _b.sent();
                        if (!endereco) {
                            return [2 /*return*/, { error: true, msg: "Erro ao tentar excluir o endereco com o id_cliente: " + id }];
                        }
                        return [4 /*yield*/, clienteRepository.query("delete from telefones where id_cliente = ".concat(id))];
                    case 2:
                        telefone = _b.sent();
                        if (!telefone) {
                            return [2 /*return*/, { error: true, msg: "Erro ao tentar excluir o telefone com o id_cliente: " + id }];
                        }
                        return [4 /*yield*/, clienteRepository.query("delete from clientes where id = ".concat(id))];
                    case 3:
                        cliente = _b.sent();
                        if (!cliente) {
                            return [2 /*return*/, { error: true, msg: "Erro ao tentar excluir o cliente: " + id }];
                        }
                        return [2 /*return*/, { error: false, msg: "Cliente excluso com sucesso." }];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                updateCliente = clienteRepository.createQueryBuilder("clientes")
                    ...
                    .execute();
                if (!updateCliente) {
                    return [2 /*return*/, { error: true, msg: "Ocorreu um erro ao atualizar os dados do cliente." }];
                }
                enderecoService = new EnderecoService_1.EnderecoService();
                ...
                return [2 /*return*/, { error: false, msg: "Os dados do cliente foram atualizados com sucesso." }];
            });
        });
    };
