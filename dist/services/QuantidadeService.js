...
var QuantidadeService = /** @class */ (function () {
    ...
    QuantidadeService.prototype.salvarQuantidade = function (dados) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (!salvarqtd) {
                    return [2 /*return*/, { error: "Erro ao salvar a quantidade do produto." }];
                }
                return [2 /*return*/];
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        quantidadeRepository = (0, typeorm_1.getCustomRepository)(QuantidadeRepositories_1.QuantidadeRepositories);
                        return [4 /*yield*/, quantidadeRepository.createQueryBuilder("quantidades")
                    ...
                    case 1:
                        ...
                        if (entrada_saida == '1') {
                            ...
                            darEntrada = quantidadeRepository.createQueryBuilder("quantidades")
                                ...
                                .execute();
                            if (!darEntrada) {
                                return [2 /*return*/, { error: "Ocorreu um erro ao atualizar a quantidade de entrada." }];
                            }
                            dadosEstoque = {
                            ...
                            return [2 /*return*/, { success: "Quantidade atualizada com sucesso." }];
                        }
                        if (entrada_saida == '0') {
                            // Saída
                            if (quantidade < unidade) {
                                return [2 /*return*/, { error: "Você não pode dar uma quantidade de saída maior que sua quantidade em estoque." }];
                            }
                            quantidadeNova = quantidade - unidade;
                            darSaida = quantidadeRepository.createQueryBuilder("quantidades")
                                ...
                                .execute();
                            if (!darSaida) {
                                return [2 /*return*/, { error: "Ocorreu um erro ao atualizar a quantidade de saída." }];
                            }
                            dadosEstoque = {
                                id_produto: id_produto,
                                entrada: null,
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (unidade > quantidade) {
                            return [2 /*return*/, { error: "A quantidade escolhida não pode ser maior que a quantidade em loja." }];
                        }
                        if (unidade <= 0) {
                            return [2 /*return*/, { error: "A quantidade escolhida tem que ser maior que zero." }];
                        }
                        return [2 /*return*/, unidade];
                }
            });
        });
    };
