            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, fornecedorRepository.save(fornecedorCreate)];
                    case 1:
                        fornecedorSalvar = _a.sent();
                        if (!fornecedorSalvar) {
                            return [2, { error: true, msg: "Error ao tentar cadastrar o fornecedor." }];
                        }
                        return [4, fornecedorRepository.query("select max(id) as id_fornecedor from fornecedores")];
                    case 2:
                        idInserido = _a.sent();
                        ...
                        if (!enderecoCadastrar) {
                            return [2, { error: true, msg: "Error ao tentar cadastrar o endereço do fornecedor." }];
                        }
                        ...
                        if (!telefoneCadastrar) {
                            return [2, { error: true, msg: "Error ao tentar cadastrar o telefone do fornecedor." }];
                        }
                        return [2, { error: false, msg: "Fornecedor cadastrado com sucesso." }];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, fornecedorRepository.query(dadosFornecedores)];
                    case 1:
                        filtrarFornecedores = _a.sent();
                        return [2, filtrarFornecedores];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4, fornecedorRepository.query("delete from enderecos where id_fornecedor = ".concat(id))];
                    case 1:
                        endereco = _b.sent();
                        if (!endereco) {
                            return [2, { error: true, msg: "Erro ao tentar excluir o endereco com o id_fornecedor: " + id }];
                        }
                        return [4, fornecedorRepository.query("delete from telefones where id_fornecedor = ".concat(id))];
                    case 2:
                        telefone = _b.sent();
                        if (!telefone) {
                            return [2, { error: true, msg: "Erro ao tentar excluir o telefone com o id_fornecedor: " + id }];
                        }
                        return [4, fornecedorRepository.query("delete from fornecedores where id = ".concat(id))];
                    case 3:
                        fornecedor = _b.sent();
                        if (!fornecedor) {
                            return [2, { error: true, msg: "Erro ao tentar excluir o fornecedor: " + id }];
                        }
                        return [2, { error: false, msg: "Fornecedor excluso com sucesso." }];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                updateFornecedor = fornecedorRepository.createQueryBuilder("fornecedores")
                    ...
                    .execute();
                if (!updateFornecedor) {
                    return [2, { error: true, msg: "Ocorreu um erro ao atualizar os dados do fornecedor." }];
                }
                enderecoService = new EnderecoService_1.EnderecoService();
                uf = null;
                ...
                return [2, { error: false, msg: "Os dados do fornecedor foram atualizados com sucesso." }];
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, fornecedoresRepository.query(dadosFornecedores)];
                    case 1:
                        filtrarFornecedores = _a.sent();
                        return [2, filtrarFornecedores];
                }
