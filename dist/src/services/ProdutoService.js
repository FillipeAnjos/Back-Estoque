            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, produtoRepository.createQueryBuilder("produtos")
                    ...
                    case 1:
                        ...
                        return [2, { success: "Retorno da quantidade de produtos.", qtd: produtoId }];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4, produtoRepository.save(produtoSalvado)];
                    case 1:
                        prod = _b.sent();
                        if (!prod) {
                            return [2, { error: "Erro ao salvar o produto." }];
                        }
                        ...
                        return [2, { success: "Produto salvo com sucesso.", prod: prod }];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4, produtoRepository.query(dadosProdutos)];
                    case 1:
                        filtrarProdutos = _b.sent();
                        return [2, filtrarProdutos];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        produtoRepository = (0, typeorm_1.getCustomRepository)(ProdutoRepositories_1.ProdutoRepositories);
                        if (!id) {
                            return [2, { error: "Erro código invalido." }];
                        }
                        return [4, produtoRepository.createQueryBuilder("produtos")
                                .update("produtos")
                                .set({ status: acao })
                    ...
                    case 1:
                        produto = _b.sent();
                        if (!produto) {
                            return [2, { error: "Erro ao tentar desativar o item." }];
                        }
                        return [2, acao == false ? { success: "Produto desativado com sucesso." } : { success: "Produto ativado com sucesso." }];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        prodSalved = _b.sent();
                        if (!prodSalved) {
                            return [2, { error: "Erro ao atualizar o produto." }];
                        }
                        valorService = new ValorService_1.ValorService();
                        valorService.salvarValor(codigo, valor);
                        return [4, this.listarProdutos(status)];
                    case 2:
                        produtosListados = _b.sent();
                        return [2, { success: "Produto atualizado com sucesso.", prod: produtosListados }];
                }
            });
        });
    };
