            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4, usersRepository.findOne({ email: email })];
                    case 1:
                        userExiste = _b.sent();
                        if (userExiste) {
                        ...
                        return [4, (0, bcryptjs_1.hash)(senha, 8)];
                    case 2:
                        senhaHash = _b.sent();
                        ...
                        return [4, usersRepository.save(userSalved)];
                    case 3:
                        usuario = _b.sent();
                        return [2, { success: "Usuário criado com sucesso.", usuario: usuario }];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, userRepository.findOne({ id: id })];
                    case 1:
                        user = _a.sent();
                        if (!user) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        userRepository = (0, typeorm_1.getCustomRepository)(UsersRepositories_1.UsersRepositories);
                        return [4, userRepository.findOne({ email: email })];
                    case 1:
                        user = _b.sent();
                        if (!user) {
                        ...
                        return [4, (0, bcryptjs_1.compare)(senha, user.senha)];
                    case 2:
                        senhHash = _b.sent();
                        if (!senhHash) {
                            error = { status: false, error: "Email e/ou Senha incorretos.." };
                        ...
                        return [2, { status: true, success: "Usuário logado com sucesso.", id: user.id, name: user.nome, email: user.email, token: token }];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        usersRepository = (0, typeorm_1.getCustomRepository)(UsersRepositories_1.UsersRepositories);
                        return [4, usersRepository.createQueryBuilder("users")
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        usersRepository = (0, typeorm_1.getCustomRepository)(UsersRepositories_1.UsersRepositories);
                        return [4, usersRepository.query("select * from users order by id desc limit 5")];
                    case 1:
                        usuarios = _a.sent();
                        return [2, usuarios];
                }
