                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (dados.itens.length == 0) {
                            return [2, { error: true, msg: "Sua lista de produtos está vazia, favor informar os produtos da venda." }];
                        }
                        duplicados = this.verItensDuplicados(dados);
                        return [4, duplicados];
                    case 1:
                        if (_a.sent()) {
                            return [2, { error: true, msg: "Error: Você não pode adicionar dois produtos com o mesmo código." }];
                        }
                        ...
                        if (dados.modalidade.dinheiro) {
                            ...
                            return [2, { error: true, msg: "Error: Você precisa informar qual a modalidade de pagamento." }];
                        }
                        return [4, fechamentoService.buscarIdFechamento()];
                    case 2:
                    ...
                    case 5:
                        ...
                        return [4, queryRunner.manager.query("insert into vendas (id_fechamento, id_user, desconto, modalidade, valor_total, data, obs) values (".concat(idFechamento, ", ").concat(dados.id_user, ", ").concat(dados.valores.desconto, ", '").concat(modalidadeEscolhida, "', ").concat(dados.valores.valortotal, ", '").concat(dataAtual, "', '").concat(dados.obs, "')"))];
                    case 6:
                        _a.sent();
                        return [4, queryRunner.manager.query("select max(id) as id_venda from vendas")];
                    case 7:
                        idInserido_1 = _a.sent();
                        arrayUpdateQuantidade = [];
                        return [4, Promise.all(dados.itens.map(function (ele) { return __awaiter(_this, void 0, void 0, function () {
                                var qtdProduto, quantidadeNova;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4, queryRunner.manager.query("insert into itens (id_venda, id_produto, valor_atual, unidade, data) values (".concat(idInserido_1[0].id_venda, ", ").concat(ele.id, ", ").concat(ele.valor, ", ").concat(ele.unidade, ", '").concat(dataAtual, "')"))];
                                        case 1:
                                            _a.sent();
                                            return [4, queryRunner.manager.query("select quantidade from quantidades where id_produto = ".concat(ele.id))];
                                        case 2:
                                            qtdProduto = _a.sent();
                    ...
                    case 8:
                        ...
                        arrayUpdateQuantidade.forEach(function (item) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4, queryRunner.manager.query("update quantidades set quantidade = ".concat(item.qtd, " where id_produto = ").concat(item.id_produto))];
                                    case 1:
                                        _a.sent();
                                        return [4, queryRunner.manager.query("insert into estoques (id_produto, entrada, saida, saldo, valor_atual, acao) values (".concat(item.id_produto, ", null, ").concat(item.qtd_saida, ", ").concat(item.qtd, ", ").concat(item.valor, ", 'Venda')"))];
                                    case 2:
                                        _a.sent();
                                        return [2];
                                }
                    ...
                    case 11:
                        _a.sent();
                        return [2, { error: true, msg: "Ocorreu um erro ao tentar realizar a venda. Favor entrar em contato com o administrador do sistema. Desculpe!" }];
                    case 12: return [4, queryRunner.release()];
                    case 13:
                        _a.sent();
                        return [7];
                    case 14: return [2, { error: false, msg: "Venda realizada com sucesso!" }];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        vendaRepository = (0, typeorm_1.getCustomRepository)(VendaRepositories_1.VendaRepositories);
                        return [4, vendaRepository.createQueryBuilder("vendas")
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        vendaRepository = (0, typeorm_1.getCustomRepository)(VendaRepositories_1.VendaRepositories);
                        return [4, vendaRepository.createQueryBuilder("vendas").getMany()];
                    case 1:
                        vendas = _a.sent();
                        return [2, vendas];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, vendaRepository.query(dadosVendas)];
                    case 1:
                        filtrarVendas = _a.sent();
                        return [2, filtrarVendas];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, vendaRepository.query(query)];
                    case 1:
                        vendas = _a.sent();
                        return [2, vendas[0].vendasmes];
                }
            });
        });
    };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        if (!(i <= 12)) return [3, 4];
                        _b = (_a = array).push;
                        return [4, this.buscarVendasPorMes(i)];
                    case 2:
                        _b.apply(_a, [_c.sent()]);
                        _c.label = 3;
                    case 3:
